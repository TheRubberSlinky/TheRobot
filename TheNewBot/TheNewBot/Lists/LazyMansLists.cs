...
namespace TheNewBot.Lists
{
    class LazyMansLists
    {
        string CurrentPlace = AppDomain.CurrentDomain.BaseDirectory;
        public List<string> catfacts = new List<string>()
        {
...
"The claws on the cat’s back paws aren’t as sharp as the claws on the front paws because the claws in the back don’t retract and, consequently, become worn."
        ...
        public List<string> ball8Answers = new List<string>()
        {
            "It is certain",
            "It is decidedly so",
            "Without a doubt",
        ...
        public Dictionary<string, string> flipwordsDict()
        {
        ...
        public List<string> DogList()
        {
            ...
            string text = CurrentPlace + @"Lists\DogFacts.txt";
            rd = Classes.XmlReader.ReadTextFile(text);
            return rd;
        }
        ...
        {
            List<string> rd = new List<string>();
            string text = CurrentPlace + @"Lists\AnimalFacts.txt";
            rd = Classes.XmlReader.ReadTextFile(text);
            return rd;
        }
    }
